    ...
    <>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<div className="mt-5"><h2 className="display-5 fw-bold text-center">Welcome to Octofit Tracker!</h2><p className="lead text-center">Track your fitness, join teams, and compete on the leaderboard.</p></div>} />
        </Routes>
      </div>
    </>
  );

...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        activities = [
            ...
            {'user_email': 'ironman@marvel.com', 'activity': 'Running', 'duration': 45},
        ]
        leaderboard = [
        ...
        workouts = [
            {'user_email': 'batman@dc.com', 'workout': 'Strength', 'reps': 100},
            {'user_email': 'cap@marvel.com', 'workout': 'Cardio', 'reps': 80},
        ]
